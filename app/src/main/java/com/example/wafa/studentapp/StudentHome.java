...
//here Intent of Home Buttons
    ...
    public void goTochat(View v){
        ...
        Intent k = new Intent(this, StudentChatTeacher.class);   //chat Activity
        startActivity(k);
    }
    ...
    public void goToUniversity(View v){
        ...
        Intent m = new Intent(this, University.class);        // University Activity
        startActivity(m);
    }

    public void goToEvent(View v){

        Intent k = new Intent(this, EventMain.class);       // Event Activity
        startActivity(k);
    }
    public void goToContactUs(View v){

        Intent k = new Intent(this, ContactUS.class);        // ContactUS Activity
        startActivity(k);
    }

    public void goToSchedule(View v){

        Intent k = new Intent(this, ScheduleMain.class);        // ScheduleMain Activity
        startActivity(k);
    }
